...
router.post("/",  upload.single("photo"),reqAuth, requireRole("Admin", "Security", "Employee"), createVisitor);
router.get("/:id", reqAuth, requireRole("Admin", "Security", "Employee"), getVisitorById);
router.patch("/:id", reqAuth, requireRole("Admin", "Security"), updateVisitorById);
