...
export const salsa20 =  createCipher(salsaCore, {
    allowShortKeys: true,
    counterRight: true,
});
...
export const xsalsa20poly1305 =  wrapCipher({ blockSize: 64, nonceLength: 24, tagLength: 16 }, function xsalsapoly(key, nonce) {
    return {
        encrypt(plaintext) {
...
export const _poly1305_aead = (fn) => (key, nonce, AAD) => {
    ...
    return {
        encrypt(plaintext) {
            const data = fn(key, nonce, plaintext, undefined, 1); 
...
export const chacha20poly1305 =  wrapCipher({ blockSize: 64, nonceLength: 12, tagLength: 16 }, _poly1305_aead(chacha20));
export const xchacha20poly1305 =  wrapCipher({ blockSize: 64, nonceLength: 24, tagLength: 16 }, _poly1305_aead(xchacha20));
