...
exports.xsalsa20poly1305 = (0, utils_ts_1.wrapCipher)({ blockSize: 64, nonceLength: 24, tagLength: 16 }, (key, nonce) => {
    return {
        encrypt(plaintext, output) {
            output = (0, utils_ts_1.getOutput)(plaintext.length + 32, output, false); 
            const authKey = output.subarray(0, 32); 
            const ciphPlaintext = output.subarray(32); 
            output.set(plaintext, 32);
            (0, utils_ts_1.clean)(authKey); 
            (0, exports.xsalsa20)(key, nonce, output, output); 
            const tag = (0, _poly1305_ts_1.poly1305)(ciphPlaintext, authKey); 
            output.set(tag, 16); 
            (0, utils_ts_1.clean)(output.subarray(0, 16), tag); 
        ...
        decrypt(ciphertext, output) {
            ...
            (0, utils_ts_1.clean)(tmp); 
            const authKey = (0, exports.xsalsa20)(key, nonce, tmp, tmp); 
            const tag = (0, _poly1305_ts_1.poly1305)(ciphPlaintext, authKey); 
