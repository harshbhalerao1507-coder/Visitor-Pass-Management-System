...
const EMPTY_SALT =  new Uint32Array(8);
...
const BLAKE256_W =  new Uint32Array(16);
...
const BLAKE512_W =  new Uint32Array(32);
...
function G1b(a, b, c, d, msg, k) {
    ...
    let Al = BBUF[2 * a + 1], Ah = BBUF[2 * a]; 
    let Bl = BBUF[2 * b + 1], Bh = BBUF[2 * b]; 
    let Cl = BBUF[2 * c + 1], Ch = BBUF[2 * c]; 
    let Dl = BBUF[2 * d + 1], Dh = BBUF[2 * d]; 
...
export const blake224 =  createOptHasher((opts) => new BLAKE224(opts));
export const blake256 =  createOptHasher((opts) => new BLAKE256(opts));
export const blake384 =  createOptHasher((opts) => new BLAKE384(opts));
export const blake512 =  createOptHasher((opts) => new BLAKE512(opts));
